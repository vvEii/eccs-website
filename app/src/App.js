...
function App() {
  ...
  return (
    <div className="App">
      ...
      <div className="bg-no-repeat bg-center w-screen h-screen py-8" style={{ backgroundImage: "url(https://images.squarespace-cdn.com/content/5d375649e2ffc000016e0aec/1566216421263-WABITDNT9SVT641I149X/20140302_Trade%2B151_0503.jpg?format=2500w&content-type=image%2Fjpeg)"}} >
      </div>
